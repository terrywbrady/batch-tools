...
class auxFields {
  ...
  public static function initAuxFields() {
    ...
    addAuxField("ItemId", "Item id number in DSpace", "i.item_id", "", false);

    addAuxField("Available", "Date or date range item became available to the public.", self::getFieldByName("date","available"), "dc.date.available", false);
    addAuxField("Accession", "Date DSpace takes possession of item.", self::getFieldByName("date","accessioned"), "", false);
    addAuxField("Accmo", "Month DSpace takes possession of item.", self::getMonthByName("date","accessioned"), "", false);
    addAuxField("Issue", "Date of publication or distribution.", self::getFieldByName("date","issued"), "dc.date.issued", false);
    addAuxField("Create", "Date of creation or manufacture of intellectual content if different from date.issued.", self::getFieldByName("date","created"), "dc.date.created[en_US]", false);
    addAuxField("UnqualDate", "Qualified dates are prefered within the system", self::getFieldByName("date",null), "dc.date[en_US]", false);
    addAuxField("Creator", "", self::getFieldByName("creator",null), "dc.coreator[en_US]", false);
    addAuxField("Author", "", self::getFieldByName("contributor","author"), "dc.contributor.author[en_US]", false);
    addAuxField("URI", "", self::getFieldByName("identifier","uri"), "", false);
    addAuxField("RelURI", "URI to external resource", self::getFieldByName("relation","uri"), "dc.relation.uri[en_US]", false);
    addAuxField("Publisher", "", self::getFieldByName("publisher",null), "dc.publisher[en_US]", false);
    addAuxField("Subject", "", self::getFieldByName("subject",null), "dc.subject[en_US]", false);
    addAuxField("Format", "", self::getFieldByName("format",null), "dc.format[en_US]", false);
    addAuxField("Type", "", self::getFieldByName("type",null), "dc.type[en_US]", false);
    addAuxField("Provenance", "", self::getFieldByName("description","provenance"), "", false);
...
EOF;
    addAuxField("GenThumb", "Thumbnail Generated by DSpace default generator", "({$thumb})", "", true);
...
inner join item2bundle i2b
  ...
  and i2b.item_id=i.item_id
EOF;
    addAuxField("ThumbName", "Name of the thumbnail file", "({$thumbName})", "", false);
...
inner join item2bundle i2b
  ...
  and i2b.item_id=i.item_id
EOF;
    addAuxField("OrigName", "Name of the original file", "({$origName})", "", false);
...
EOF;
    addAuxField("OtherName", "Name of auxilliary files", "({$otherName})", "", false);
...
inner join item2bundle i2b
  ...
  and i2b.item_id=i.item_id
EOF;
    addAuxField("Text", "", "({$textName})", "", false);
...
inner join item2bundle i2b
  ...
  and i2b.item_id=i.item_id
EOF;
    addAuxField("SizeMB", "Size of the original file MB", "({$size})", "", false);
...
inner join item2bundle i2b
  ...
  and i2b.item_id=i.item_id
EOF;
    addAuxField("OrigId", "Assetstore Id", "({$origId})", "", false);
    addAuxField("Private", "Private Item", "case when i.discoverable = false then 'Private' else 'Discoverable' end", "", false);
...
EOF;
    addAuxField("BitRestricted", "Original Restricted", "({$bitRestricted})", "", false);
