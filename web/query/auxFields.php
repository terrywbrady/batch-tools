...
class auxFields {
  ...
  public static function initAuxFields() {
    ...
    self::addAuxField("Accmo", "Month DSpace takes possession of item.", self::getMonthByName("date","accessioned"), "", false);
    ...
    self::addAuxField("UnqualDate", "Qualified dates are prefered within the system", self::getFieldByName("date",null), "dc.date[en_US]", false);
    self::addAuxField("Creator", "", self::getFieldByName("creator",null), "dc.coreator[en_US]", false);
    self::addAuxField("Author", "", self::getFieldByName("contributor","author"), "dc.contributor.author[en_US]", false);
...
EOF;
    self::addAuxField("GenThumb", "Thumbnail Generated by DSpace default generator", "({$thumb})", "", true);
...
inner join item2bundle i2b
  ...
  and i2b.item_id=i.item_id
EOF;
    self::addAuxField("Text", "", "({$textName})", "", false);
